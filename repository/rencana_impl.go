...
func (u *RencanaRepo) CreateRencana(data entity.Rencana) error {
	row, err := u.db.Exec("INSERT INTO rencana (nama_rencana, waktu_rencana) VALUES (?, ?)", data.NamaRencana, data.WaktuRencana)
	if err != nil {
		return err
	}
